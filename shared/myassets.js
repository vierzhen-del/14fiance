...
async function renderMyAssets() {
  ...
  const taxSummaryHTML = `
    <details class="collapse-box" style="margin-top:20px;">
      <summary><span>🧾 세금 상세 (눌러서 펼치기)<br><span style="font-weight:400; font-size:12px; color:var(--text-muted);">💰 인출 가능 ${fmtW(totalReceivableNowDiv)} · 원천징수 ${fmtW(totalWithheldTax)} · 종합과세 ${finPctNow.toFixed(1)}%</span></span></summary>
