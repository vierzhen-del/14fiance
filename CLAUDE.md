...
- 배경·과거 결정이 필요해 보이면 답하기 전에 연동된 노션 운영지침 문서부터 검색·확인한다. 사용자에게 재설명을 요구하지 않는다. 검색해도 없거나 불확실하면 "모름" 표기 후 질문한다 (2026-07-16, NotebookLM 외장 기억 제안 검토 결과 — 신규 도구 대신 기존 체계 보강으로 결정).
